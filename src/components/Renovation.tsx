        ...
        <blockquote className="instagram-media" data-instgrm-captioned
          ...
          <div style={{padding:'16px'}}> <a
              ...
              <div style={{display: 'flex', flexDirection: 'row',alignItems: 'center'}}>
                <div style={{background: '#F4F4F4', borderRadius:'50%', flexGrow:'0', height:'40px', marginRight:'14px', width:'40px'}}>
                </div>
                <div className="reno1">
                  <div
                    className='reno2'>
              ...
              <div className="reno4"><svg width="50px" height="50px"
              ...
              <div
                ...
                <div className="reno16">
                </div>
              </div>
            </a>
            <p
              className="reno17">
              <a href="https://www.instagram.com/reel/CVav6owPCaq/?utm_source=ig_embed&amp;utm_campaign=loading"
                className='insta'
                target="_blank">A post shared by CoJo LLC (@cojo.dreamhomes)</a>
            </p>
          </div>
        </blockquote>
